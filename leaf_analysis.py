...
def load_and_process_image(image_path, threshold):
    """
    ...
    try:
        ...
        # In this case, the threshold is passed by parameter
        lower_hue = np.array([15, 50, 50])  # Range for yellow-brown
        upper_hue = np.array([threshold, 255, 255]) # Here's the threshold
...
def analyze_leaf(filepath, threshold):
    """
    ...
    """
    image, leaf_mask, infected_mask = load_and_process_image(filepath, threshold)
